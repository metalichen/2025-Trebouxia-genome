...
* [Output of kallisto showing raw counts and transcript per milion values for the transcriptomic analysis](https://github.com/metalichen/2025-Trebouxia-genome/blob/main/results/tpm_long.txt)